...
const CONTRACTS = {
  ...
  planner: (s) => ({
    ...
    answers: {
      checked: '{ "week_cost_per_person_usd": …, "average_dinner_cost_per_person_usd": …, "budget_usd": …, "all_rules_passed": true|false, "checks": [{ "rule", "passed", "detail" }], "meals": [each dinner with its cost] }',
