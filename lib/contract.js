...
const CONTRACTS = {
  ...
  shopper: () => ({
    ...
    tools: {
      ...
      build_week_cart: 'The week’s Kroger cart for one plan and a number of people (default 50), without saving anything: each dinner scaled to that many people, every product to buy in whole packages, what it is used for, and the total.',
    ...
    data_sources: [
      ...
      'Costs and carts come from the Recipe Pricer and are added up by the coordinator. Never send costs or products.',
    ],
    checks: {
    ...
    answers: {
      cart: '{ "plan_id", "group", "people", "lines": [{ "description", "size", "price_usd", "packages", "cost_usd", "estimated", "used_for" }], "total_usd", "per_person_usd" (the cart ÷ people, with whole packages), "plan_cost_per_person_usd" (the plan’s own cost, from shares of packages), "estimated_lines", "note" }',
