...
const CONTRACTS = {
  ...
  shopper: () => ({
    ...
    example: { plan_id: '<id from list_meal_plans>', reason: 'Passes every check at $2.40 a dinner, the cheapest of the three that do, and four of its five dinners were picked by more than one group.' },
  }),
};
