...
// number of people in the Pricer's instructions, and the cost per serving.
...
export function pricingSummary(p) {
  ...
  return {
    ...
    estimated_lines: p.estimated_lines ?? 0, // ingredients whose price the Pricer estimated (Kroger had none)
  };
}
