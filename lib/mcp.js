...
nutrition yourself; check a draft of five dinners, Monday to Friday,
with check_meal_plan; then save it with save_meal_plan.
Recipe Pricer: a separate agent prices every saved recipe and saves the price here; see /pricer.
