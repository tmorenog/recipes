...
// For each recipe the Scouts save, it finds every ingredient at the class's
...
export const DEFAULT_PROMPT = `You are the Recipe Pricer, one of the agents in the class's Meal Squad system. For each recipe, build the Kroger shopping cart needed to cook it and find out what it costs, so the Meal Planners can compare recipes by price. You only price.
