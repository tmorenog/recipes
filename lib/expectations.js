...
const BRIEFS = {
  ...
  planner: () => ({
    ...
    steps: [
      'Call list_recipes with priced: true. Each recipe has its ingredients and pricing.cost_per_serving_usd, worked out by the Pricer agent. If fewer than 5 are priced, say so and finish.',
      'Estimate the nutrition of one serving of each promising recipe (calories, protein_g, fiber_g, sodium_mg) from its ingredients and est_servings. search_foods gives USDA values per 100 g for plain foods; use it for the main ingredients.',
