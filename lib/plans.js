...
const answer = (e) => ({
  ...
  checks: e.checks,
  meals: e.meals.map(({ day, recipe_id, meal_id, name, cuisine, category, image_url, why, cost_per_serving_usd, price_estimated, pick_count, picked_by, nutrition_per_serving }) =>
    ({ day, recipe_id, meal_id, name, cuisine, category, image_url, why, cost_per_serving_usd, price_estimated, pick_count, picked_by, nutrition_per_serving })),
