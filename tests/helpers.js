...
export const BACKENDS = [
  {
    ...
    async fresh() {
      ...
      await pool.query('drop table if exists backup_runs, coordinator_settings, exchanges, recipe_picks, pricer_tests, prompt_overrides, pricer_config, pricer_steps, pricer_cache, pricings, recipes, activity, plans cascade');
